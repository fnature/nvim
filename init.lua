...
-- Folding can be based on 'indent','manual','syntax','marker'
vim.opt.foldmethod = 'indent'
-- This ensures that all folds are open by default unless you manually close them
...
require('lazy').setup({
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          mappings = {
            i = {
              -- In insert mode, to delete the selected buffer
  ...
  { --
    ...
    --    options = {
    --      terminal_colors = false, -- set to true or false as desired
    --     },
    --   })
    -- end,
  },
